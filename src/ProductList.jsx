...
function ProductList({ onHomeClick }) {
    ...
    const calculateTotalQuantity = () =>{
        return currentItems ? currentItems.reduce((total, item) => total + item.quantity, 0) : 0; 
    }
    ...
    return (
        <div>
                ...
                <div style={styleObjUl}>
                    ...
                    <div style={{ display: 'inline-block' }}>
                        ...
                        >
                            ...
                            {/* Contador de Productos en el centro */}
                            <span style={{
                            position: 'absolute',
                            top: '52%',
                            left: '52%',
                            ...
                            fontSize: '20px',
                            fontWeight: 'bold',
                            pointerEvents: 'none'       // Para que los clics atraviesen hasta el enlace
                            }}>
            ...
            {!showCart ? (
                <div  >
                    {plantsArray.map( (plantCat, index) => (
                        <div key={index}  className='product-grid'>
                           <h2 className='plant_heading' >{plantCat.category}</h2>

                           <div className='product-list'>
                                {plantCat.plants.map((plant, index) => (
                                ...
                                <div key={index} className='product-card'>
                                    <p className='product-title'> {plant.name}</p>
                                        ...
                                        <p style={{padding: '12px', fontStyle: 'italic' }}  >{plant.description}</p>
